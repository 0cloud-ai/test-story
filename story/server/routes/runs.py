...
from story.db.queries import runs as run_q, stories as story_q, steps as step_q
...
from story.models.story import parse_meta
from story.server.deps import get_db, get_executor, get_event_bus
from story.server.sse import EventBus, format_sse
...
async def quick_run(
    ...
    if collection_id:
        from story.db.queries import collections as coll_q
